...
class Charge(Base):
    ...
    Renamed from `Invoice` in the invoicing-foundation work — `Invoice` now
    refers to the Czech-law tax-invoice document (separate model). A row
    here records a payment attempt against ComGate, not a legal invoice.
